...
[DependsOn(
    typeof(NFTMarketServerTestBaseModule)
)]
public class NFTMarketServerDomainTestModule : AbpModule
{
    public override void ConfigureServices(ServiceConfigurationContext context)
    {
        ...
        context.Services.Configure<IndexSettingOptions>(options =>
        {
            ...
            options.IndexPrefix = "nftmarketservertest";
        });
    }
        ...
        modules.ForEach(m =>
        {
            ...
            foreach (var t in types)
            {
                AsyncHelper.RunSync(async () =>
                    await elasticIndexService.DeleteIndexAsync("nftmarketservertest." + t.Name.ToLower()));
            }
        });
    }
