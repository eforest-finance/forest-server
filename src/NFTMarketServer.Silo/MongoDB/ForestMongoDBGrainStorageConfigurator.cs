...
public class ForestMongoDBGrainStorageConfigurator : IPostConfigureOptions<MongoDBGrainStorageOptions>
{
    private readonly IServiceProvider _serviceProvider;

    public ForestMongoDBGrainStorageConfigurator(IServiceProvider serviceProvider)
    {
