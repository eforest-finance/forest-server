...
public class NFTCollectionChangeService : NFTMarketServerAppService, INFTCollectionChangeService
{
    ...
    [ExceptionHandler(typeof(Exception),
        Message = "NFTCollectionChangeService.HandleItemsChangesAsync failed collectionChanges",
        LogOnly = true,
        TargetType = typeof(ExceptionHandlingService),
        MethodName = nameof(ExceptionHandlingService.HandleExceptionRetrun),
        LogTargets = new[] { "collectionChanges" }
    )]
    public virtual async Task<long> HandleItemsChangesAsync(string chainId, List<IndexerNFTCollectionChange> collectionChanges)
    {
        long blockHeight = -1;
    ...
    [ExceptionHandler(typeof(Exception),
        Message = "NFTCollectionChangeService.HandlePriceChangesAsync failed collectionChanges",
        LogOnly = true,
        TargetType = typeof(ExceptionHandlingService),
        MethodName = nameof(ExceptionHandlingService.HandleExceptionRetrun),
        LogTargets = new[] { "chainId", "collectionChanges", "lastEndHeight", "businessType" }
    )]
    public virtual async Task<long> HandlePriceChangesAsync(string chainId,
