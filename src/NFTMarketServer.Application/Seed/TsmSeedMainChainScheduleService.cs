...
public class TsmSeedMainChainScheduleService : ScheduleSyncDataService
{
    ...
    public TsmSeedMainChainScheduleService(ILogger<TsmSeedMainChainScheduleService> logger, IGraphQLProvider graphQlProvider,
    ...
    public override async Task<long> SyncIndexerRecordsAsync(string chainId, long lastEndHeight, long newIndexHeight)
    {
        ...
        _logger.LogInformation(
            "SyncTsmSeedMainChainRecordsAsync queryList startBlockHeight: {lastEndHeight} endBlockHeight: {newIndexHeight} count: {count}",
    ...
    {
        return BusinessQueryChainType.TsmSeedSymbolMainChain;
    }
}