...
public class SynchronizeAITokenJobGrain : Grain<SynchronizeAITokenState>, ISynchronizeAITokenJobGrain
{
    ...
    public SynchronizeAITokenJobGrain(ILogger<SynchronizeTxJobGrain> logger,
        ...
        SaveSynchronizeAITokenJobGrainDto input)
    {
        if (State == null || State.Id.IsNullOrEmpty())
        {
            State = new SynchronizeAITokenState()
            {
                Id = input.Symbol,
                Symbol = input.Symbol,
                Status = CrossCreateTokenStatus.Init,
    ...
    public virtual async Task<GrainResultDto<SynchronizeAITokenJobGrainDto>> ExecuteJobAsync(SynchronizeTxJobGrainDto input)
    {
