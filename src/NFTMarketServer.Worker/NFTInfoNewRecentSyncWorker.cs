...
public class NFTInfoNewRecentSyncWorker : NFTMarketServerWorkBase
{
    protected override BusinessQueryChainType BusinessType => BusinessQueryChainType.NftInfoNewRecentSync;

    public NFTInfoNewRecentSyncWorker(ILogger<ScheduleSyncDataContext> logger,
