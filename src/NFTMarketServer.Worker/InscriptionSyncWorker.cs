...
public class InscriptionSyncWorker : NFTMarketServerWorkBase
{
    protected override BusinessQueryChainType BusinessType => BusinessQueryChainType.InscriptionCrossChain;

    public InscriptionSyncWorker(ILogger<ScheduleSyncDataContext> logger,
