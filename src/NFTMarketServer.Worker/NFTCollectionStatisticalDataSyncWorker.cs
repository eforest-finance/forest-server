...
public class NFTCollectionStatisticalDataSyncWorker : NFTMarketServerWorkBase
{
    protected override BusinessQueryChainType BusinessType => BusinessQueryChainType.CollectionExtenstion;

    public NFTCollectionStatisticalDataSyncWorker(ILogger<ScheduleSyncDataContext> logger,
