...
public class SeedSymbolSyncWorker : NFTMarketServerWorkBase
{
    protected override BusinessQueryChainType BusinessType => BusinessQueryChainType.SeedSymbolSync;

    public SeedSymbolSyncWorker(ILogger<ScheduleSyncDataContext> logger,
